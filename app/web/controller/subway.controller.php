...
class subwayController extends BaseController {
	 ...
	 * 获取地铁换乘方案
	 *
	 * @param type $start_line 起点线路
	 * @param type $start_site 起点站点
	 * @param type $end_line   终点线路
	 * @param type $end_site   终点站点
	 */
	 ...
	 *
	 * @param type $db
	 * @param type $start_line
	 * @param type $start_site
	 * @param type $end_line
	 * @param type $end_site
	 * @param type $remove
	 * @param type $tmp_dis
	...
	private function C_taransfer($cid, $start_line, $start_site, $end_line, $end_site, &$remove = array(), $tmp_dis = 0, $tmp_line = '', $tmp_count = 0) {
		...
		if($start_line == $end_line) {
			...
			//$arr['join'] = array("subway as s" => "s.line = t.line and s.name = t.name", "subway as t_s" => "t_s.line = t.t_line and t_s.name = t.t_name");
